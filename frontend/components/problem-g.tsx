...
const Problem = () => {
  return (
    <MathJax>
      <>
        <div css={style.title}>G. 배열의 원소 찾기 ( Hard )</div>
        ...
        <div css={style.sectionContent}>
          <p>Easy 버전과 제한의 차이만 존재합니다.</p>
          <p>
            입출력의 양이 많아 빠른 입출력이 필요한 문제입니다. 검색에 별다른
            제약이 없으므로 검색해서 사용해주시면 감사하겠습니다.
          </p>
          <p>
        ...
        <div css={style.sectionContent}>
          ...
          <p>
            둘째 줄에 N개의 정수가 공백으로 나눠져 주어집니다. 각각의 정수는
            모두 다릅니다.
          </p>
          <p>셋째 줄에 위치를 찾고자 하는 원소의 개수 Q가 주어집니다.</p>
          <p>
            넷째 줄 부터 Q+3번째 줄 까지 찾고자하는 원소가 한줄에 하나씩
            주어집니다.
          </p>
        </div>
        ...
        <div css={style.sectionContent}>
          <p>
            찾고자 하는 원소의 위치를 출력합니다. 위치는 1부터 시작해서 N까지
            입니다.
          </p>
        </div>
